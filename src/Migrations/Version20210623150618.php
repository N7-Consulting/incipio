...
final class Version20210623150618 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        // $this->addSql('ALTER TABLE Bdc ADD CONSTRAINT FK_59751EFDE2904019 FOREIGN KEY (thread_id) REFERENCES Thread (id)');
        ...
        // $this->addSql('ALTER TABLE Cca ADD CONSTRAINT FK_F9F88321E2904019 FOREIGN KEY (thread_id) REFERENCES Thread (id)');
