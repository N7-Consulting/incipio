...
class DocTypeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('name', Select2ChoiceType::class, [
                'required' => true,
                'label' => 'suivi.document_type',
                ...
                'choices' => [
                    ...
                    'Suivi d\'étude' => [
                        ...
                        'suivi.avant_projet' => TraitementController::DOCTYPE_AVANT_PROJET,
                        ...
                        'CDC (A MODIFIER)' => TraitementController::DOCTYPE_CDC,
                        'PC (A MODIFIER)' => TraitementController::DOCTYPE_PC,
                        'CCA (A MODIFIER)' => TraitementController::DOCTYPE_CCA,
                        'CCA (A MODIFIER)' => TraitementController::DOCTYPE_CCA,
                        'BDC (A MODIFIER)' => TraitementController::DOCTYPE_BDC,
            ...
            ->add('verification', CheckboxType::class, [
