...
`paramDescription`, `priority`) VALUES (NULL, \'fraisDossierDefaut\', \'number\', \'90\', \'1\', 
\'Frais de dossier par défaut\', \'Fixé dans l Avant-Projet\', \'810\')');
        $this->addSql('INSERT INTO `AdminParam` (`id`, `name`, `paramType`, `defaultValue`, `required`, `paramLabel`, 
`paramDescription`, `priority`) VALUES (NULL, \'pourcentageAcompteDefaut\', \'number\', \'0.4\', \'1\', 
\'Acompte par défaut\', \'Fixé dans la Convention Client\', \'800\')');
    }
